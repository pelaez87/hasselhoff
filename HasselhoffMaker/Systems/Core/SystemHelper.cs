...
namespace HasselhoffMaker.Systems.Core
{
    ...
    internal static class SystemHelper
    {
        ...
        //Custom Methods
        #region SYSTEM ENUM
        static private eSystem _system = eSystem.Unknown;
        /// <summary>
        /// Gets the name of the operating system running on this computer.
        /// </summary>
        static public eSystem System
        {
            get
            {
                if (_system != eSystem.Unknown)
                    return _system;
                ...
                if (GetVersionEx(ref osVersionInfo))
                {
                    ...
                    {
                        case PlatformID.Win32S:
                            _system = eSystem.Windows31;
                            break;
                        case PlatformID.WinCE:
                            _system = eSystem.WindowsCE;
                            break;
                        case PlatformID.Win32Windows:
                            {
                                if (majorVersion == 4)
                                {
                                    ...
                                    switch (minorVersion)
                                    {
                                        case 0:
                                            if (csdVersion == "B" || csdVersion == "C")
                                                _system = eSystem.Windows95_OSR2;
                                            else
                                                _system = eSystem.Windows95;
                                            break;
                                        case 10:
                                            if (csdVersion == "A")
                                                _system = eSystem.Windows98SE;
                                            else
                                                _system = eSystem.Windows98;
                                            break;
                                        case 90:
                                            _system = eSystem.WindowsMe;
                                            break;
                                    }
                                }
                                break;
                        ...
                        case PlatformID.Win32NT:
                            {
                                ...
                                {
                                    case 3:
                                        _system = eSystem.WindowsNT351;
                                        break;
                                    case 4:
                                        switch (productType)
                                        {
                                            case 1:
                                                _system = eSystem.WindowsNT40;
                                                break;
                                            case 3:
                                                _system = eSystem.WindowsNT40Server;
                                                break;
                                        }
                                        break;
                                    case 5:
                                        ...
                                        {
                                            case 0:
                                                _system = eSystem.Windows2000;
                                                break;
                                            case 1:
                                                _system = eSystem.WindowsXP;
                                                break;
                                            case 2:
                                                _system = eSystem.WindowsServer2003;
                                                break;
                                        }
                                        break;
                                    case 6:
                                        switch (minorVersion)
                                        {
                                            case 0:
                                                ...
                                                {
                                                    case 1:
                                                        _system = eSystem.WindowsVista;
                                                        break;
                                                    case 3:
                                                        _system = eSystem.WindowsServer2008;
                                                        break;
                                                }
                                                break;
                                            ...
                                            case 1:
                                                ...
                                                {
                                                    case 1:
                                                        _system = eSystem.Windows7;
                                                        break;
                                                    case 3:
                                                        _system = eSystem.WindowsServer2008R2;
                                                        break;
                                                }
                                                break;
                                            case 2:
                                                ...
                                                {
                                                    case 1:
                                                        _system = eSystem.Windows8;
                                                        break;
                                                    case 3:
                                                        _system = eSystem.WindowsServer2012;
                                                        break;
                                                }
                                                break;
                                            case 3:
                                                _system = eSystem.Windows8_1;
                                                break;
                                            case 4:
                                                _system = eSystem.Windows10;
                                                break;
                                        }
                                        break;
                                }
